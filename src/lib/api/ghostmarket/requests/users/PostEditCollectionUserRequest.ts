...
export interface ISignDataEditCollectionUser {
    /** Timestamp until when the operation can be performed */
    timestamp: number

    /** Method */
    method: 'UserEditCollection'
...
export class PostEditCollectionUserRequest {
    /** slug */
    slug!: string
    ...
    /** data signed */
    data!: ISignDataEditCollectionUser

    public constructor(init: PostEditCollectionUserRequest) {
